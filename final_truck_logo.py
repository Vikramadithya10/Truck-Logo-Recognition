#python final_truck_logo.py --image images/1.jpg --output output/1_test.jpg
...
try:
    ...
    cv2.putText(img,'No known logos detected.', (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0,0,255), 2)

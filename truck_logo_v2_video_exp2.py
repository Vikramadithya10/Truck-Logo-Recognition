#python truck_logo_v2_video_exp2.py --input images/vid.mp4 --config ./truck_logo_weights/version_2.1/yolov4-obj.cfg --weights ./truck_logo_weights/version_2.1/yolov4-obj_best.weights --names ./truck_logo_weights/version_2.1/obj.names --output output/vid_out.avi
...
out = cv2.VideoWriter(args["output"],fourcc, 25.0, (fwidth,fheight))

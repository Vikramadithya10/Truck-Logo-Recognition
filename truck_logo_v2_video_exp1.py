    ...
    if detection:
        ...
        for index in indices:
            ...
            if index == 11:
                ...
                cv2.putText(img, f'{classes[class_ids[index]]}__{index}', (x, y - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0,255,0), 2)
            else:
                cv2.rectangle(img, (x, y), (x + w, y + h), (255,0,0), 1)
                cv2.putText(img, classes[class_ids[index]], (x, y - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255,0,0), 2)
            cv2.rectangle(img, (x, y), (x + w, y + h), (0,255,0), 1)
